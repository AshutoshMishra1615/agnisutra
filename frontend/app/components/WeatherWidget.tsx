...
export default function WeatherWidget({ weather }: WeatherWidgetProps) {
  return (
    <div className="">
      ...
      <div className="bg-[#364031] mb-4 grid grid-cols-4 md:grid-cols-8 gap-3 p-4 rounded-xl">
        {weather.map((day, index) => (
          <div key={index} className="text-center rounded-lg border-[0.2px] border-black  shadow-[0_2.03_3.29_rgba(0,0,0,0.59)] hover:bg-[#1f2e1e] py-2">
